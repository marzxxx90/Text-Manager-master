...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2015 at 07:43 AM
...
--
-- Table structure for table `expiryreports`
--

CREATE TABLE IF NOT EXISTS `expiryreports` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `TICKET_NO` int(10) NOT NULL,
  `TRANSDATE` date DEFAULT NULL,
  `NAME` varchar(30) NOT NULL,
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8mb4 AUTO_INCREMENT=788 ;
...
--
-- Table structure for table `sentreports`
--

CREATE TABLE IF NOT EXISTS `sentreports` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `sentdate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `contactName` varchar(50) NOT NULL,
